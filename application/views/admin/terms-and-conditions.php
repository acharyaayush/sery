                ...
                <div class="card">
                    ...
                    <form method="POST" action="<?php echo base_url('admin/Update_CMS')?>" class="needs-validation" novalidate="">
                        <div class="card-body">
                            ...
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">English Content</label>
                                <div class="col-sm-12 col-md-7">

                                    <textarea class="summernote" id="summernote" name="page_value">
                                        <?php if(!empty($cms_data)){echo stripslashes($cms_data[0]['page_value']);} ?>
                                    </textarea>
                                </div>
                            </div>
                            <div class="form-group row mb-4">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                    ...
                                    <input type="hidden" name="page_primary_id" value="<?php if(!empty($cms_data)){echo $cms_data[0]['id'];} ?>" />
                                     <input type="hidden" name="view_landing_page" value="terms_and_conditions" />
