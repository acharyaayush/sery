...
$provider_order_list_tr = "";
if(!empty($provider_order_details)){
    /*echo '<pre>';
    print_r($provider_order_details);*/
    foreach ($provider_order_details as $value) {
    ...
    $provider_order_list_tr = "<tr><td class='text-center' colspan='6' class='no-records'>No Records Found </td></tr>";
}
...
<tbody>
    <?php echo  $provider_order_list_tr;?>
</tbody>