...
<tr>
    <?php
        if($mode == 1 ){
    ?>
    <td>Greetings from <?php echo APP_NAME;?>. You're receiving this mail because you are successfully registered on <?php echo APP_NAME;?> as <b>Customer Service</b>.</td>
    <?php
    }
    ?>
...
<tr>
   <td>Name: <?php echo $name;?><br>Contact : +<?php echo COUNTRY_CODE.' '. $mobile;?><br><br>Email : <?php echo $email;?> <?php
        if($mode == 1 ){
    ?><br>Password : <?php echo $password;?><br>Login Url : <?php echo base_url('admin/')?><?php
    }
    ?></td>
</tr>
