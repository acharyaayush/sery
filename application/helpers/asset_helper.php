...
if ( ! function_exists('js_url'))
{
    ...
    {
        $CI =& get_instance();
        return base_url() . $CI->config->item('js_module_path');
    }
}
 ...
 * @return  string
 */
if ( ! function_exists('js_module_path'))
{
    function js_module_path()
    {
        //get an instance of CI so we can access our configuration
        $CI =& get_instance();
        return base_url() . $CI->config->item('js_module_path');
 ...
 * @return  string
 */
if ( ! function_exists('img_upload_path'))
{
    function img_upload_path()
    {
        $CI =& get_instance();
        return  array($CI->config->item('img_upload_path'),base_url().$CI->config->item('img_upload_path'));
    }
}

/**
 * Get the Absolute Invoice Upload Path
 *
 * @access  public
 * @return  string
 */
if ( ! function_exists('order_invoice_upload_path'))
{
    function order_invoice_upload_path()
    {
        $CI =& get_instance();
        return  array($CI->config->item('order_invoice_upload_path'),base_url().$CI->config->item('order_invoice_upload_path'));
    }
}
...
if ( ! function_exists('upload_path_relative'))
{
    ...
    {
        $CI =& get_instance();
        return './' . $CI->config->item('img_upload_path');
    }
}
...
//reffrence from https://github.com/sekati/codeigniter-asset-helper/blob/master/README.md